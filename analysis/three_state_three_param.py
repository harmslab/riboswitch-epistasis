...
def _A_residual(params,K_2AP,K_mg,n_mg,Rt,At,Mt):
    ...
    A = params[0]
    E, D, DA, M = _calc_all_conc(K_2AP,K_mg,n_mg,Rt,At,Mt,A)
...
def _species_conc(K_2AP,K_mg,n_mg,
                  Rt,At,Mt,
...
def species_conc(logK_2AP,logK_mg,n_mg,
                 Rt,At,Mt,
                 convergence_cutoff=0.01,
                 guess_resolution=0.1,
                 verbose=True):
    """
    Get species of E, D, DA, A, and M given logged equilibrium
...
def fx_A(logK_2AP=-3,logK_mg=-6,n_mg=1,some_df=None,At=50):
    ...
    E, D, DA, A, M = species_conc(logK_2AP,logK_mg,n_mg,
